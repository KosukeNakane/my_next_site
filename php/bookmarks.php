...
// Ensure table exists (optional safe-guard; ignore error if already exists)
try {
...
if ($method === 'POST') {
  ...
  try {
    $stmt = $pdo->prepare('INSERT IGNORE INTO bookmarks (user_id, path, title) VALUES (:uid, :path, :title)');
