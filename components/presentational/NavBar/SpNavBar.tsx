...
const SpNavBar = ({
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 py-0.5 md:py-2 ${"bg-white/70 text-gray-800"} ${mode === "benton" ? "font-bentonModernDisplay" : ""} backdrop-blur-md transition-opacity duration-300 ${showNav ? "opacity-100" : "opacity-0"}`}
    >
          ...
          {mobileOpen && (
            <div className="sm:hidden">
              <div className="fixed inset-0 z-[60]" aria-hidden={true}>
                <div className="absolute inset-0" onClick={onToggleMobile} />
